...
public class WindowsTabbed {
    ...
    private JButton createDrawerButton() {
        JButton cmd = new JButton(new FlatSVGIcon("team3/svg/menu.svg", 0.9f));
    ...
    private JScrollPane createScroll(Component com) {
        ...
        scroll.getHorizontalScrollBar().putClientProperty(
                FlatClientProperties.STYLE, "" + "width:0");
        scroll.getHorizontalScrollBar().setUnitIncrement(10);
        scroll.putClientProperty(
                FlatClientProperties.STYLE, "" + "border:0,0,0,0");
