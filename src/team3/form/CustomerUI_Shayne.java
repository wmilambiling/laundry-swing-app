package team3.form;
 ...
 import java.sql.*;
 import team3.sql.CustomerCrud_Shayne;
...
public class CustomerUI_Shayne extends TabbedForm {

	private CustomerCrud_Shayne crud;
	private DefaultTableModel model;
	private TableRowSorter<DefaultTableModel> rowSorter;

   	public CustomerUI_Shayne() {
    	initComponents();   // auto-generated by NetBeans
    	crud = new CustomerCrud_Shayne();  // initialize your CRUD
...
public static void main(String[] args) {
    javax.swing.SwingUtilities.invokeLater(() -> {
        ...
        frame.setContentPane(new CustomerUI_Shayne()); // add your form panel
